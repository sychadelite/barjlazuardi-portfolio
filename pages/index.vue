  ...
  <div class="min-h-screen">
    <section class="relative xl:container xl:m-auto w-full">
      <div class="grid grid-cols-12 border-x border-x-black lg:divide-x divide-black border-black">
        ...
        <div class="col-span-8 max-lg:col-span-12 text-lg xs:text-3xl sm:text-5xl font-dune-rise font-extrabold capitalize">
          ...
          <div class="flex flex-row divide-x divide-black">
            <div class="w-full border-b border-black divide-y divide-black">
              <div class="px-1 md:px-4 py-10 lg:py-12">
                <div class="flex flex-wrap justify-around gap-2 lg:hidden">
                  <img src="/img/icons/nazi.svg" alt="nazi" class="h-24 grayscale mx-6 my-auto">
                  <div class="flex flex-col justify-center items-center font-normal mt-3">
                    <h1 class="text-5xl font-jugendstil-ornamente tracking-widest">Ba</h1>
                    <h1 class="text-6xl font-genjiro tracking-[.2em]">()^&%</h1>
                    <h1 class="text-5xl font-genjiro tracking-wide">&rarr;&rarr;&rarr;</h1>
                  </div>
        ...
        <div class="col-span-2 max-lg:hidden text-sm font-space-mono font-normal uppercase border-b border-black divide-y divide-black">
          <div class="px-4 py-6 lg:py-12 w-full h-full">
            <div class="flex flex-col justify-between items-center h-full">
              <img src="/img/icons/barj-illuminate.png" alt="barj" class="h-24 -mt-3.5">
              <h1 class="text-7xl font-jugendstil-ornamente">B</h1>
              ...
              <img src="/img/icons/nazi.svg" alt="nazi" class="h-24 grayscale">
            </div>
          </div>
        </div>
        <div class="col-span-1 max-lg:hidden flex">
...
export default {
  ...
  data() {
    return {
      ...
      projects: [
        { id: 1, name: 'Find Art Mystery - Apps', country: 'ID', date: '2021-06-19 00:00:00', cover: '/img/web/resized/find.png', stacks: [ '/img/stacks/unity.png', '/img/stacks/laravel.png', '/img/stacks/c-sharp.png', '/img/stacks/mysql.png' ], url: 'https://play.google.com/store/apps/details?id=com.Pradita.Find&hl=en_US&gl=US', description: 'AR-based application that has various features such as indoor navigation, AR object exhibition and AR-based games using the Unity Engine. can be used inside summarecon mall serpong.' },
        { id: 2, name: 'Wrathnet JD', country: 'ID', date: '2021-10-30 00:00:00', cover: '/img/web/resized/wrathnet.png', stacks: [ '/img/stacks/vue.png', '/img/stacks/laravel.png', '/img/stacks/php.png', '/img/stacks/mysql.png' ], url: 'https://wrathnet.com', description: 'Jade Dynasty Wrathnet portal web game with player\'s CMS and integrated transaction using available payment gateways located in indonesia.' },
        { id: 3, name: 'Teamremod JD', country: 'VE', date: '2023-01-30 00:00:00', cover: '', stacks: [ '/img/stacks/laravel.png', '/img/stacks/php.png', '/img/stacks/mysql.png' ], url: 'https://teamremod.com', description: 'Jade Dynasty Teamremod portal web game with player\'s CMS and integrated transaction using available payment gateways located in venezuela.' },
        { id: 4, name: 'Vengance JD', country: 'US', date: '2023-01-30 00:00:00', cover: '', stacks: [ '/img/stacks/laravel.png', '/img/stacks/php.png', '/img/stacks/mysql.png' ], url: 'https://vengancejd.com', description: 'Jade Dynasty Vengance portal web game with player\'s CMS and integrated transaction using available payment gateways located in united states.' },
        { id: 5, name: 'Admin Teamremod JD', country: 'VE', date: '2023-01-30 00:00:00', cover: '', stacks: [ '/img/stacks/vue.png', '/img/stacks/laravel.png', '/img/stacks/php.png', '/img/stacks/mysql.png' ], url: 'https://special.teamremod.com', description: 'Jade Dynasty Teamremod portal web game admin panel with a complex CMS located in venezuela.' },
        ...
        { id: 9, name: 'Lapak Satwa', country: 'ID', date: '2024-01-19 00:00:00', cover: '/img/web/resized/lapaksatwa.png', stacks: [ '/img/stacks/vue.png', '/img/stacks/laravel.png', '/img/stacks/php.png', '/img/stacks/mysql.png' ], url: 'https://lapaksatwa.co.id', description: 'Lapak Satwa is an official, secure marketplace and auction platform for buying and selling pets, ensuring safety and trust in every transaction.' },
      ],
      workflow: [
