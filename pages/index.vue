  ...
  data() {
    return {
      ...
      projects: [
        ...
        { id: 6, name: 'TPID', country: 'ID', date: '2023-01-09 00:00:00', cover: '/img/web/resized/tpid.png', stacks: [ '/img/stacks/codeigniter.png', '/img/stacks/php.png' ], url: 'http://103.50.218.58/tpid', description: 'The Regional Inflation Control Team website, which was developed by Tangerang City Communications and Information Department. It features a basic CMS and a user-friendly interface, designed for a client located in Indonesia.' },
        { id: 7, name: 'Kadaku', country: 'ID', date: '2023-02-13 00:00:00', cover: '/img/web/resized/kadaku.png', stacks: [ '/img/stacks/nuxt.png', '/img/stacks/laravel.png', '/img/stacks/php.png' ], url: 'https://kadaku.id', description: 'Digital invitation website in Indonesia allows users to buy and customize templates to match their preferred designs and formats.' },
        { id: 8, name: 'Local Champion', country: 'ID', date: '2023-09-25 00:00:00', cover: '/img/web/resized/local-champion.png', stacks: [ '/img/stacks/vue.png', '/img/stacks/laravel.png', '/img/stacks/php.png' ], url: 'https://localchampion.id', description: 'Integrated - sustainable community empowerment platform to bring forth sustainable innovations that benefit both their local communities and the world.' },
      ],
      workflow: [
