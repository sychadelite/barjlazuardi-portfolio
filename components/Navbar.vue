  ...
  data() {
    return {
      ...
      social_media: [
        ...
        { id: 2, name: 'linkedin', url: 'https://www.linkedin.com/in/barjlazuardi/', icon: '<i class="fa-brands fa-linkedin-in"></i>' },
        { id: 3, name: 'instagram', url: 'https://instagram.com/barjlazuardi', title: 'instagram', icon: '<i class="fa-brands fa-instagram"></i>' },
        { id: 4, name: 'x', url: 'https://x.com/themoltisanti', title: 'instagram', icon: '<i class="fa-brands fa-x-twitter"></i>' },
        { id: 5, name: 'facebook', url: 'https://facebook.com/barjlazuardi', title: 'instagram', icon: '<i class="fa-brands fa-facebook"></i>' },
        { id: 6, name: 'threads', url: 'https://threads.net/barjlazuardi', title: 'instagram', icon: '<i class="fa-brands fa-threads"></i>' },
        { id: 7, name: 'discord', url: 'https://discord.com/users/41767866263312793', title: 'instagram', icon: '<i class="fa-brands fa-discord"></i>' },
